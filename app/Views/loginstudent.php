                    ...
                    <div class="form-section">
                        ...
                        <div class="login-inner-form">
                            <form action="<?= base_url('student-login') ?>" method="post">
                                ...
                                <input type="text" id="ic_number" name="ic_number" value="<?= old('ic_number') ?>"><br>
                                <i class="flaticon-mail-2"></i>
                                </div>
                                <div class="form-group form-box">
                                    <input type="password" name="stu_password" class="input-text" placeholder="Password">
                                ...
                                <div class="form-group mb-0">
                                    <button type="submit" class="btn-md btn-theme btn-block" style="background-color: #FFBE00; color: #ffffff;">Log Masuk</button>
                                </div>
